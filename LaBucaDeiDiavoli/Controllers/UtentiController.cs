...
namespace LaBucaDeiDiavoli.Controllers
{
    ...
    public class UtentiController : Controller
    {
        ...
        {
            var utenteLoggato = db.Utenti.FirstOrDefault(u => u.Username == utente.Username && u.Password == utente.Password);
            if (utenteLoggato != null)
            {
                FormsAuthentication.SetAuthCookie(utenteLoggato.Username, false);
